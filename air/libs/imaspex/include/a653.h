...
typedef enum {
	...
	IDLE_MODE              = AIR_MODE_IDLE,
	COLD_START_MODE        = AIR_MODE_COLD_START,
	WARM_START_MODE        = AIR_MODE_WARM_START,
	NORMAL_MODE            = AIR_MODE_NORMAL
...
typedef enum {
    INVALID_TYPE    = AIR_MESSAGE_INVALID,
    VALID_TYPE      = AIR_MESSAGE_VALID
} VALIDITY_TYPE;
