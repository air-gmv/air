...
#define SPW_RXBD_ERROR (SPW_RXBD_EEP | SPW_RXBD_ETR)
...
#define SPW_PREPAREMASK_TX                                                                                             \
    (SPW_DMACTRL_RXEN | SPW_DMACTRL_PS | SPW_DMACTRL_TA | SPW_DMACTRL_RA | SPW_DMACTRL_RD | SPW_DMACTRL_NS)
