...
#define GRCAN_STAT_TXERRCNT 0xff0000
     ...
     */
    uint32_t iop_grcan_close(iop_device_driver_t *iop_dev, void *args);
    ...
    /* Set Acceptance filters, provide pointer to "struct grcan_filter" or NULL to disable filtering (let all messages
     * pass) */
