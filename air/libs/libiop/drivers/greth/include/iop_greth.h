...
#define GRETH_TXD_STATS (GRETH_TXD_UNDERRUN | GRETH_TXD_RETLIM | GRETH_TXD_LATECOL)
...
#define GRETH_RXD_STATS (GRETH_RXD_OVERRUN | GRETH_RXD_DRIBBLE | GRETH_RXD_TOOLONG | GRETH_RXD_CRCERR)
