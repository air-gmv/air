...
/**
 * @brief Get pointer of RT mode allocated memory
 * @return Pointer to beginning of RT allocated memory
 */
...
/**
 * @brief Get pointer of BC mode allocated memory
 * @return Pointer to beginning of BC allocated memory
 */
