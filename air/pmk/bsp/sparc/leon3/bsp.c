...
void bsp_segregation(pmk_partition_t *partition)
{
    ...
    cpu_segregation_map_memory(partition->mmu_ctrl, &air_kernel_memory_start, &air_kernel_memory_start,
                               (air_uptr_t)&air_kernel_memory_end - (air_uptr_t)&air_kernel_memory_start, 0x01000000,
                               PMK_MMU_SR | PMK_MMU_SW | PMK_MMU_SE | PMK_MMU_CACHEABLE);

    cpu_segregation_map_memory(partition->mmu_ctrl, (void *)0x80000000, (void *)0x80000000, 0x80000000, 1 << 24,
