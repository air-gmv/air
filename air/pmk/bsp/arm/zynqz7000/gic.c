...
void arm_generate_swi(air_u32_t cpu_filter, air_u32_t cpu_list, air_u32_t nonsecure, air_u32_t sgi_id)
{
    ...
    ICD->icdsgir = (ARM_SGI_TARGET(cpu_filter) | ARM_SGI_TARGET_MASK(cpu_list) | (nonsecure << 15) | sgi_id);
}
