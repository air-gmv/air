...
void bsp_segregation(pmk_partition_t *partition)
{
    ...
    printk("   :: BSP segregation\n"
           ...
           (air_uptr_t *)&air_kernel_memory_start, (air_uptr_t *)&air_kernel_memory_end,
           (air_uptr_t)&air_kernel_memory_end - (air_uptr_t)&air_kernel_memory_start, (air_uptr_t *)&air_workspace);
#endif

    /* Map PMK into partition mmu with supervisor access */
    cpu_segregation_map_memory(partition->mmu_ctrl, (void *)&air_kernel_memory_start, (void *)&air_kernel_memory_start,
                               (air_uptr_t)&air_kernel_memory_end - (air_uptr_t)&air_kernel_memory_start, 0x00100000,
                               PMK_MMU_SR | PMK_MMU_SW | PMK_MMU_SE | PMK_MMU_CACHEABLE);

    /* TODO SECURITY FLAW ALSO IN SPARC */
    cpu_segregation_map_memory(partition->mmu_ctrl, (void *)0xe0000000, (void *)0xe0000000,
                               (air_uptr_t)(0xffffffff - 0xe0000000 + 1), 0x00100000,
