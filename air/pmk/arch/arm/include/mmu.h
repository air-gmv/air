...
#define MMU_ACCESS_RO(level, type) ((level == MMU_L1) ? MMU_ACCESS_RO_SECT : MMU_ACCESS_RO_PAGE)
#define MMU_ACCESS_UP(level, type) ((level == MMU_L1) ? MMU_ACCESS_UP_SECT : MMU_ACCESS_UP_PAGE)
#define MMU_ACCESS_A(level, type) ((level == MMU_L1) ? MMU_ACCESS_A_SECT : MMU_ACCESS_A_PAGE)
#define MMU_ACCESS_XN(level, type)                                                                                     \
    ((level == MMU_L1) ? MMU_ACCESS_XN_SECT : ((type == MMU_LPAGE) ? MMU_ACCESS_XN_LPAGE : MMU_ACCESS_XN_PAGE))
#define MMU_ACCESS_NG(level, type) ((level == MMU_L1) ? MMU_ACCESS_NG_SECT : MMU_ACCESS_NG_PAGE)
...
#define MMU_ATTR_S(level, type) ((level == MMU_L1) ? MMU_ATTR_S_L1 : MMU_ATTR_S_L2)
#define MMU_TEX_OFFSET_ 12
#define MMU_TEX_OFFSET_PAGE 6
#define MMU_TEX_OFFSET(level, type)                                                                                    \
    ((level == MMU_L2 && (type == MMU_PAGE1 || type == MMU_PAGE2)) ? MMU_TEX_OFFSET_PAGE : MMU_TEX_OFFSET_)
