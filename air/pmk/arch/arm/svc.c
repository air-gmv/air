...
void arm_svc_handler(arm_interrupt_stack_frame_t *frame, pmk_core_ctrl_t *core)
{
    ...
    case AIR_SYSCALL_GET_PARTITION_STATUS:
        ...
        frame->r0 = (air_u32_t)pmk_syscall_get_partition_status(core, (air_identifier_t)frame->r0,
    ...
    case AIR_SYSCALL_GET_SCHEDULE_ID:
        ...
        frame->r0 =
            (air_u32_t)pmk_syscall_get_schedule_id(core, (air_name_ptr_t)frame->r0, (air_identifier_t *)frame->r1);
        break;
    ...
    case AIR_SYSCALL_GET_PORT_ID:
        ...
        frame->r0 = (air_u32_t)pmk_syscall_get_port_id(core, (air_port_type_e)frame->r0, (air_name_ptr_t)frame->r1,
    ...
    case AIR_SYSCALL_CREATE_PORT:
        ...
        frame->r0 = (air_u32_t)pmk_syscall_create_port(core, (air_port_type_e)frame->r0, (air_name_ptr_t)frame->r1,
                                                       (void *)frame->r2, (air_identifier_t *)frame->r3);
        break;
    case AIR_SYSCALL_GET_PORT_STATUS:

        // Get the status of a port based on its identifier
        frame->r0 = (air_u32_t)pmk_syscall_get_port_status(core, (air_port_type_e)frame->r0, (air_identifier_t)frame->r1,
                                                           (air_identifier_t)frame->r2, (void *)frame->r3);
        break;
    ...
    case AIR_SYSCALL_READ_PORT:
        ...
        frame->r0 = (air_u32_t)pmk_syscall_read_port(core, (air_port_type_e)frame->r0, (air_identifier_t)frame->r1,
                                                     (air_message_ptr_t)frame->r2, (air_sz_t *)frame->r3,
    ...
    case AIR_SYSCALL_WRITE_PORT:
        ...
        frame->r0 = (air_u32_t)pmk_syscall_write_port(core, (air_port_type_e)frame->r0, (air_identifier_t)frame->r1,
                                                      (air_message_ptr_t)frame->r2, (air_sz_t)frame->r3,
                                                      (void *)((air_uptr_t *)frame->usr_sp)[0]);
        break;
    case AIR_SYSCALL_GET_SHARED_AREA:
        ...
        frame->r0 =
            (air_u32_t)pmk_syscall_get_sharedmemory(core, (air_name_ptr_t)frame->r0, (air_sharedmemory_t *)frame->r1);
        break;
    ...
    case AIR_SYSCALL_SET_SYSTEM_STATE:
        ...
        frame->r0 = (air_u32_t)pmk_syscall_set_system_state(core, (air_state_e)frame->r0);
        break;
    
    case AIR_SYSCALL_GET_HM_LOG:

        // Get the health monitor log
        frame->r0 = (air_u32_t) pmk_get_hm_log(core, (air_hm_log_t *)frame->r0);
        break;

    case AIR_SYSCALL_POP_FROM_HM_LOG:

        // Pop an event from the health monitor log
    ...
    case AIR_SYSCALL_GET_HM_EVENT:
        ...
        frame->r0 = (air_u32_t)pmk_syscall_get_hm_event(core, (air_hm_event_t *)frame->r0);
        break;
    ...
    case AIR_SYSCALL_PRINT:
        ...
        frame->r0 = (air_u32_t)pmk_syscall_print(core, (char *)frame->r0, (air_sz_t)frame->r1);
        break;
    ...
    case AIR_SYSCALL_ARM_ACK_INT:
        ...
        break;
    case AIR_SYSCALL_ARM_DISABLE_ALIGNMENT_CHECKING:
        arm_cp15_disable_alignment_checking();

        break;
    case AIR_SYSCALL_ARM_ENABLE_ALIGNMENT_CHECKING:
        arm_cp15_enable_alignment_checking();
