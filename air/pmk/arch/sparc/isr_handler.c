 ...
 */
static void *sparc_partition_isr_virtualization(sparc_interrupt_stack_frame_t *isf, pmk_core_ctrl_t *core_ctrl)
{
 ...
 * @brief
 */
void *sparc_isr_handler(sparc_interrupt_stack_frame_t *isf, pmk_core_ctrl_t *core, air_u32_t tn)
{
    ...
    if (core->partition != NULL && core->context->isr_nesting_level == 1)
    {
