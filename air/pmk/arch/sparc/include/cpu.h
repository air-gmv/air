 ...
 */
#define cpu_enable_preemption(flags) flags = sparc_enable_preemption()

/**
 * @brief CPU disable preemption
 * @param flags Preemption flags
 */
#define cpu_disable_preemption(flags) sparc_disable_preemption(flags)

/**
 * @brief CPU health-monitor initialization
 */
#define cpu_hm_init() sparc_healthmonitor_init()

/**
 * @brief CPU segregation initialization
 */
#define cpu_segregation_init() sparc_segregation_init()
 ...
 */
#define cpu_copy_to_user(ctx, dst, src, size) sparc_copy_to_user((ctx), (dst), (src), (size))

/**
 * @brief CPU segregation copy from user-land
 */
#define cpu_copy_from_user(ctx, dst, src, size) sparc_copy_from_user((ctx), (dst), (src), (size))

/**
 * @brief CPU get physical address
 */
#define cpu_get_physical_addr(ctrl, v_addr) sparc_get_physical_addr((ctrl), (v_addr))
 ...
 */
#define core_context_save(core) sparc_core_context_save((void *)(core))

/**
 * @brief Restores the core context
 * @param core_ctrl control control pointer
 */
#define core_context_restore(core) sparc_core_context_restore((void *)(core))
 ...
 */
#define core_context_tbr(context) (context)->vcpu.tbr
