...
# @author lumm
# @brief AIR OS for QEMU target for ARM-ZYNQ Z7000
...
# Target Description
description = "AIR OS for QEMU target for ARM-ZYNQ Z7000"
...
-mfpu=vfpv3 -mfloat-abi=softfp -mtune=cortex-a9", #Using the softfp float abi gives more compatibility but can decrease performance
...
# specific defines
defines = ['PMK_FPU_SUPPORT=0','PMK_DEBUG','PMK_SMP=1','DEBUG_UART_ID=0', 'HM_LOG_OVERWRITE=1']
