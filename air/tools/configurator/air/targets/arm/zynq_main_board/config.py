##
# @package air.targets.arm.zynq_mainboard
# @author lasg
# @brief AIR OS for ARM Zynq Main Board for AVIOAR1
...
import utils.temp as temp_utils
...
# Target Description
description = "AIR OS for ARM-ZYNQ MAIN Board"
...
kernel_sources = [path.join(SOURCE_PMK_DIRECTORY, f) for f in [
    ...
    'bsp/arm/zynq_main_board/bsp.c',
    'bsp/arm/zynq_main_board/gic.c',
    'bsp/arm/zynq_main_board/global_timer.c',
    'bsp/arm/zynq_main_board/ipc.c',
    'bsp/arm/zynq_main_board/segregation.c',
    'bsp/arm/zynq_main_board/triple_timer.c',
    'bsp/arm/zynq_main_board/uart.c',
    'bsp/arm/zynq_main_board/slcr.c',
    'bsp/arm/zynq_main_board/xilinx/xil_assert.c',
    'bsp/arm/zynq_main_board/xilinx/xil_io.c',
    # Core files
    'core/error.c',
    'core/barrier.c',
    'core/ipc.c',
...
kernel_headers = set(utils.flatten([
    ...
    file_tools.getFilesByExtensions(path.join(SOURCE_PMK_DIRECTORY, 'bsp', 'arm', 'zynq_main_board'), ['.h', '.ld']),
]))
...
libair_sources = set(utils.flatten([
    ...
    file_tools.getFilesByExtensions(path.join(SOURCE_PAL_DIRECTORY, 'bsp', 'arm', 'zynq_main_board'), ['.c', '.S']),
...
iop = IOP(defines=[],
        devices=['xeth0', 'xeth1', 'xuart0','xuart1', 'xcan0', 'tme0', 'xsd0', 'xsd1', 'xadc0', 'xgpio0'],
        drivers=['xeth', 'xuart', 'xcan', 'tsn', 'tme', 'xsd', 'xadc', 'xgpio'],
        alias=dict(eth0='xeth0', eth1='xeth1', uart0='xuart0', uart1='xuart1', can0 = 'xcan0', tme='tme0', sd0='xsd0', sd1='xsd1', adc0='xadc0', gpio0='xgpio0'),
        arch=iop_arch)
