...
// Must be removed after add gnss .lib file
void ManageFftAcquisition(T_supportData *supportData_P, int core_index);
void setAcqChannelMod(T_supportData *supportData_P, int svnIndex, double doppler, int dopplerRange, int core_index);
void dopplerRefinementTimeDomain(T_supportData *supportData_P, T_ChData *chData_P, int slot, int svnIndex, int slotIndex, int core_index);
...
// Must be changed for extern after add gnss .lib file and
 ioBuffer_t	 ioBuffer;
...
/*  name task  id task   id perd_task    expected cpu   cpuset    run     cpu  */
  ...
  {   "TCK3"  ,  0x0   ,     0x0      ,       2       , {{0x4}} , false  , -1},  // TCR3 
  {   "ACQ1"  ,  0x0   ,     0x0      ,       0       , {{0x1}} , false  , -1},  // ACQ1
  {   "ACQ2"  ,  0x0   ,     0x0      ,       1       , {{0x2}} , false  , -1},  // ACQ2
  {   "MAIN"  ,  0x0   ,     0x0      ,       3       , {{0x8}} , false  , -1}   // MAIN
};
