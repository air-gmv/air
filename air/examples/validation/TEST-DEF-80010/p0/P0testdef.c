...
int test_main (void) {
    ...
    /* Test Steps *******************************************************    */
    /* Test Step 0 
    	Get a pointer to the text section of partition 1. Try to write an
	integer to the retrieved address. */
    test_step_announce(0,1);

    /* Test step 0 code */
    ret |= RTEMS_SUCCESSFUL;
	*areas_p1[TEST_TEXT] = 0;
    ...
    /* Test Step 2 
    	Get a pointer to the data section of partition 1. Try to write an
	integer to the retrieved address. */
    test_step_announce(2,1);

    /* Test step 2 code */
	*areas_p1[TEST_DATA] = 0;
    ...
    /* Test Step 4 
    	Get a pointer to the bss section of partition 1. Try to write an
	integer to the retrieved address. */
