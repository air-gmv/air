...
int test_main (void) {
    ...
    /* Test Steps *******************************************************    */
    /* Test Step 12 
    	Get a pointer to the text section of partition 0. Try to write an
	integer to the retrieved address. */
        
    test_step_announce(12,1);

    /* Test step 12 code */
    ret |= RTEMS_SUCCESSFUL;
	*areas_p0[TEST_TEXT] = 0;
    ...
    /* Test Step 14 
    	Get a pointer to the data section of partition 0. Try to write an
	integer to the retrieved address. */
    test_step_announce(14,1);

    /* Test step 14 code */
    ret |= RTEMS_SUCCESSFUL;
	*areas_p0[TEST_DATA] = 0;
    ...
    /* Test Step 16 
    	Get a pointer to the bss section of partition 0. Try to write an
	integer to the retrieved address. */
	...
	*areas_p0[TEST_BSS] = 0;
    ...
    /* Test Step 18 
    	Get a pointer to the text section of partition 2. Try to write an
	integer to the retrieved address. */
    test_step_announce(18,1);

    /* Test step 18 code */
    ret |= RTEMS_SUCCESSFUL;
	*areas_p2[TEST_TEXT] = 0;
    ...
    /* Test Step 20 
    	Get a pointer to the data section of partition 2. Try to write an
	integer to the retrieved address. */
    test_step_announce(20,1);
	
    /* Test step 20 code */
    ret |= RTEMS_SUCCESSFUL;
	*areas_p2[TEST_DATA] = 0;
    ...
    /* Test Step 22 
    	Get a pointer to the bss section of partition 2. Try to write an
	integer to the retrieved address. */
