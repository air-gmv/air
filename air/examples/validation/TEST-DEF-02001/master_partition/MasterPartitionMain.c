...
void ExecuteTestOnStartUp ( )
{
  ...
  /* Test T-API-INTER-520:0011 */
  /* CREATE Sampling port "SP_CREATE_TEST" */
#ifdef EXECUTE_T_API_INTER_520_0011
  printf("EXECUTE_T_API_INTER_520_0011\n");

  #ifdef  TRACE_T_API_INTER_520_0011
     TraceActive = AVT_ACTIVE;
  #else	
     TraceActive = AVT_NO_ACTIVE;
  #endif

  NrTestId = T_API_INTER_520_0011;
  Test_T_API_INTER_520_0011 ( &(TabResults[T_API_INTER_520_0011]) );
#endif
  
  /* Test T-API-INTER-520:0012 */
  /* SamplingPort creation error, and create max allowed number */
#ifdef EXECUTE_T_API_INTER_520_0012
  printf("EXECUTE_T_API_INTER_520_0012\n");
  #ifdef  TRACE_T_API_INTER_520_0012
     TraceActive = AVT_ACTIVE;
  #else	
     TraceActive = AVT_NO_ACTIVE;
  #endif

  NrTestId = T_API_INTER_520_0012;
  Test_T_API_INTER_520_0012 ( &(TabResults[T_API_INTER_520_0012]) );
#endif
...
void StartPartition ( void ){
  ...
  /* Create Sampling port "SP_MASTER_SEND" */
  w_CREATE_SAMPLING_PORT ( "SP_MASTER_SEND",
				               SAMPLING_PORT_MAX_MESSAGE_SIZE,
    				            SOURCE,
				                SAMPLING_PORT_REFRESH_TIME,
			        	        &SamplingPortId,
  ...
  if( RetCode != NO_ERROR )
  {
    WriteLogErrorFunc( RetCode,
		       "MasterPartitionMain",
		       "CREATE_SAMPLING_PORT SP_MASTER_SEND" );
  }
