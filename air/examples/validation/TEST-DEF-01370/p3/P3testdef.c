...
int test_main (void) {
    ...
    /* Test step 3 code */
    fill_section(&(sections[0]),&air_memmap_part_text3_start    , &air_memmap_part_text3_end);
    fill_section(&(sections[1]),&air_memmap_part_data3_start    , &air_memmap_part_data3_end);
    fill_section(&(sections[2]),&air_memmap_part_bss3_start     , &air_memmap_part_bss3_end );
