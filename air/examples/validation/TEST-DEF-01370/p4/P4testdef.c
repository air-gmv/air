...
int test_main (void) {
    ...
    /* Test step 15 code */
    fill_section(&(sections[0]),&air_memmap_part_text4_start    , &air_memmap_part_text4_end);
    fill_section(&(sections[1]),&air_memmap_part_data4_start    , &air_memmap_part_data4_end);
    fill_section(&(sections[2]),&air_memmap_part_bss4_start     , &air_memmap_part_bss4_end );
