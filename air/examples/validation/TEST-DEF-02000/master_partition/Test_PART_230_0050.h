 ...
 * |              concern to Test_PART_230_0050.c source.               | *
 * |                                                                    | *
 * |                                                                    | *
 * | AUTHOR:                                                            | *
 * | DATE:   16/09/2004                                                 | *
 ...
 * +--------------------------------------------------------------------+ *
 *------------------------------------------------------------------------*/
#ifndef _TEST_PART_230_0050_H_
#define _TEST_PART_230_0050_H_
...
/* +xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx+ *
 * |                                                                    | *
 * |                   END OF FILE: Test_PART_230_0050.h                | *
 * |                                                                    | *
 * +xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx+ */
