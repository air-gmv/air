 ...
 * |              concern to Test_PART_230_0040.c source.               | *
 * |                                                                    | *
 * |                                                                    | *
 * | AUTHOR:                                                            | *
 * | DATE:   27/09/2002                                                 | *
 ...
 * +--------------------------------------------------------------------+ *
 *------------------------------------------------------------------------*/
#ifndef _TEST_PART_230_0040_H_
#define _TEST_PART_230_0040_H_
...
/* +xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx+ *
 * |                                                                    | *
 * |                   END OF FILE: Test_PART_230_0040.h                | *
 * |                                                                    | *
 * +xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx+ */
