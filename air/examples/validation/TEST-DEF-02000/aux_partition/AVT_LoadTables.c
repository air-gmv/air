...
void LoadTestsName( void )
{
  ...
  strcpy( TabTestNames[T_API_PART_220_0010],   "T_API_PART_220_0010  " );
  strcpy( TabTestNames[T_API_PART_230_0010],   "T_API_PART_230_0010  " );
  strcpy( TabTestNames[T_API_PART_230_0020],   "T_API_PART_230_0020  " );
  strcpy( TabTestNames[T_API_PART_230_0030],   "T_API_PART_230_0030  " );
  strcpy( TabTestNames[T_API_PART_230_0035],   "T_API_PART_230_0035  " );  
  strcpy( TabTestNames[T_API_PART_230_0040],   "T_API_PART_230_0040  " );
  strcpy( TabTestNames[T_API_PART_230_0050],   "T_API_PART_230_0050  " );
  strcpy( TabTestNames[T_API_PART_230_0060],   "T_API_PART_230_0060  " );
