...
int test_main (void) {
    ...
    /* Test Steps *******************************************************    */
    /* Test Step 1 
    	Read the cache control register. Verify if the Data cache is enabled
	and the Code Cache is disabled. Wait for next execution window.. */
    for (repeat=1;repeat <= test_step_rep_list[2]; repeat ++) {
