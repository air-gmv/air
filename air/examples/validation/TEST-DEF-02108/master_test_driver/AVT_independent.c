 ...
 * @note The functions contained in this file should allow the user to 
 *    develop partition code independently from the target or AVT 
 *    implementation
 * 
 */
...
{
  #ifdef DEBUG
  printf("w_SET_MODULE_SCHEDULE (%u)\n", (unsigned int) SchedId);
  #endif
...
/* ---------------------------------------------------------------------- +
 * |                                                                    | *
 * | FUNCTION NAME: w_GET_MODULE_SCHEDULE_ID                            | *
 * |                                                                    | *
 * | DESCRIPTION: Execute w_GET_MODULE_SCHEDULE_ID                      | *
 * |                                                                    | *
 * | AUTHOR: Bruno Oliveira                                             | *
 * | DATE:   25/09/2013                                                 | *
 * |                                                                    | *
 ...
 * |                                                                    | *
 * ---------------------------------------------------------------------- */
void w_GET_MODULE_SCHEDULE_ID(
  SCHEDULE_NAME_TYPE ScheduleName, /* in */
  SCHEDULE_ID_TYPE *SchedId, /* out */
  RETURN_CODE_TYPE *RetCode) /* out */
{

  #ifdef DEBUG
  printf("w_GET_MODULE_SCHEDULE_STATUS %s\n", ScheduleName);
  #endif
  /*Execute Service*/
  GET_MODULE_SCHEDULE_ID( ScheduleName, SchedId, RetCode );
