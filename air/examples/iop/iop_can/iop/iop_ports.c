...
iop_port_t remote_ports[4] = {
    ...
    {.type = AIR_SAMPLING_PORT, .name = "iop_sender", .configuration = &sampling_ports[2], .device = NULL},
    {.type = AIR_SAMPLING_PORT, .name = "iop_sender2", .configuration = &sampling_ports[3], .device = NULL},
};
