 ...
 */
static air_u32_t reads_per_period[] = {1};

/**
 * @brief Routes Headers
 */
static iop_header_t route_header[1] = {{.can_header = {.extended = 1, .sshot = 1, .rtr = 0, .id = 34}}};

/**
 * @brief Routes Scheduling
 */
static air_u32_t route_schedule_0[1] = {1};

/**
 * @brief Routes Configuration
 */
static iop_physical_route_t physical_routes[1] = {
    {.schedule = route_schedule_0, .header = &route_header[0], .port = &remote_ports[2]}};
...
iop_physical_device_t physical_device_1 = {
    ...
    .routes = {.length = 1, .elements = physical_routes},
