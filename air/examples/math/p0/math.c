...
void entry_point() {
		...
		printf(" = Partition Math tests ==================================\n");
		
		printf("\n # Printing numbers\n");
		printf("   %2f %F (expected  1.50000)\n",  1.5,  1.5);
		printf("   %2f %F (expected -1.50000)\n", -1.5, -1.5);
		printf("   %2f %F (expected  0.25000)\n", 0.25, 0.25);
		printf("   %2f %F (expected  4.15000)\n", 4.15, 4.15);
		printf("   %2f %F (expected  4.00159)\n", 4.00159, 4.00159);
		printf("   %2f %F (expected  9.79000)\n", 9.7900, 9.7900);
		printf("   %f %f %f\n", 1.4, 3.2, 9.5);
		...
		printf("    1 + 2 = %f (expected 3) (int: %i)\n", res1, (int)res1);
		printf("    2 - 1 = %f (expected 1) (int: %i)\n", res2, (int)res2);
		
		printf("\n # Multiplication and Division\n");
		printf("    2 * 4 = %f (expected 8) (int: %i)\n", res3, (int)res3);
		printf("    4 / 2 = %f (expected 2) (int: %i)\n", res4, (int)res4);
		...
		printf (" = Partition Lib Math tests ==============================\n");
