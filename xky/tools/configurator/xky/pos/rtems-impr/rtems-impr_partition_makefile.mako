<%
    ...
    build_dir = os.path.relpath(xky.INSTALL_PMK_DIRECTORY, xky.SOURCE_PMK_DIRECTORY)
...
$(XKY_LIBS)/${libname.lower()}/${libname.lower()}.a${'\\' if i < len(partition.libraries) - 1 else '\\'}
% endfor
