##
# @package xky.targets.sparc.tsim
# @author pfnf
# @brief XKY OS for SPARC - TSIM (emulator)
...
# Target Description
description = "XKY OS for SPARC-LEON (tsim)"
...
kernel_compiler = dict(
    ...
    CFLAGS="",
    CPPFLAGS="-mcpu=leon3 -mhard-float -mflat -fno-builtin -nodefaultlibs -gdwarf-2 -O2 -Wall",
    CXXFLAGS="",
    LDFLAGS="",
    ARFLAGS="ruv"
)
...
kernel_compiler_no_fpu = dict(
	...
	RANLIB="sparc-rtems5-ranlib",
	CFLAGS="",
	CPPFLAGS="-mcpu=leon3 -msoft-float -mflat -fno-builtin -nodefaultlibs -gdwarf-2 -O2 -Wall",
	CXXFLAGS="",
	LDFLAGS="",
	ARFLAGS="ruv"
)
...
# memory map
mmap = MMAP(kernel_space=[0x60000000, 0x01000000],
            partition_space=[0x61000000, 0x10000000],
