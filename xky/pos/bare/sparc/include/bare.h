...
extern void sparc_lock_init(xky_u32_t *lock);
extern void sparc_lock_acquire(xky_u32_t *lock);
extern int sparc_lock_try_acquire(xky_u32_t *lock);
extern void sparc_lock_release(xky_u32_t *lock);

/**
 * @brief Lock type
 */
typedef xky_u32_t smp_lock_t;
