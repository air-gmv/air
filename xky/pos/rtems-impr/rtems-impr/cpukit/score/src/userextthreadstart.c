/**
 *  @file
 *  userextthreadstart.c
 *
 *  @brief the thread start extension which invokes all thread start
 *  extensions added
 *
                                   ...
                                   )
{
        ...
        the_node = the_node->next)
    {
        ...
        /* if it has the thread start extension */
        if(the_extension->Callouts.thread_start != NULL)
        {
            /* call the user thread start extension */
            ( *the_extension->Callouts.thread_start )( _Thread_Executing ,
                                                       the_thread );
        }
    }
}
