 ...
 *  7121    | 09/04/2010  | mcoutinho    | IPR 1931
                                     ...
                                     )
{
    ...
    switch(location)
    {
        ...
        case OBJECTS_REMOTE:
            ...
            return _RTEMS_tasks_MP_Send_request_packet(RTEMS_TASKS_MP_SUSPEND_REQUEST ,
                                                       id ,
                                                       0 , /* Not used */
                                                       0 , /* Not used */
                                                       0 /* Not used */);
        ...
        case OBJECTS_LOCAL:
            ...
            else
            {
                ...
                /* return cannot suspend a suspended task */
