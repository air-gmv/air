 ...
 *  7120    | 09/04/2010  | mcoutinho    | IPR 1931
                                   ...
                                   )
{
    ...
    /* thread to start location */
    Objects_Locations location;


    /* check if the thread entry point is NULL */
    if(entry_point == NULL)
    {
        /* return invalid entry point address */
    ...
    switch(location)
    {
        ...
        case OBJECTS_REMOTE:
            ...
            /* return illegal operation (cannot start a remote task) */
        ...
        case OBJECTS_LOCAL:
            ...
            /* check if the system is able to start the thread */
            if(_Thread_Start(the_thread ,
