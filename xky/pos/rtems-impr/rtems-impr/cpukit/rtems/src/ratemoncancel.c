 ...
 *  ratemoncancel.c
 *
 *  @brief cancel a rate monotonic period
 *
 ...
 *  576     | 17/11/2008  | mcoutinho    | IPR 64
 *  5273    | 01/11/2009  | mcoutinho    | IPR 843
 *  5317    | 02/11/2009  | mcoutinho    | IPR 831
 *  7092    | 09/04/2010  | mcoutinho    | IPR 1931
...
{
    /* rate monotonic object to cancel */
    Rate_monotonic_Control *the_period;

    /* rate monotonic object to cancel location */
    Objects_Locations location;


    /* get the rate monotonic object */
    ...
    switch(location)
    {
        ...
        case OBJECTS_LOCAL:
            ...
            /* check if the executing thread is the owner of the period */
            if(!_Thread_Is_executing(the_period->owner))
            {
                /* enable dispatch (disabled by _Rate_monotonic_Get) */
                _Thread_Enable_dispatch();

                /* return code not owner (only the owner can cancel) */
