 ...
 *  leon.h
 *
 *  @brief This include file contains information pertaining to the LEON2.
 *
 ...
 *  8307    | 21/06/2010  | mcoutinho    | IPR 451
 *  $Rev: 9872 $ | $Date: 2011-03-18 17:01:41 +0000 (Fri, 18 Mar 2011) $| $Author: aconstantino $ | SPR 2819
 *
 **/

/**
 *  @defgroup SPARC_LEON2_BSP SPARC LEON2 BSP
 *
 *  @brief The LEON2 BSP contains the specific code related to the LEON2 BSP
 *  @{
 */
...
#define LEON_INTERRUPT_EXTERNAL_3                7
   ...
   /**
    * @brief determine the interrupt source number for the Leon2 Timer1
    *
    * VENDOR_GAISLER
    **/
#define LEON_INTERRUPT_TIMER1                    8
   ...
   /**
    * @brief determine the interrupt source number for the Leon2 Timer2
    *
    * VENDOR_GAISLER
    **/
#define LEON_INTERRUPT_TIMER2                    9
   ...
   /**
    * @brief determine the interrupt source number for the Leon2 empty 1
    *
    * VENDOR_GAISLER
    **/
#define LEON_INTERRUPT_EMPTY1                    10
   ...
   /**
    * @brief determine the interrupt source number for the Leon2 empty 2
    *
    * VENDOR_GAISLER
    **/
#define LEON_INTERRUPT_EMPTY2                    11
   ...
   /**
    * @brief determine the interrupt source number for the Leon2 empty 3
    *
    * VENDOR_GAISLER
    **/
#define LEON_INTERRUPT_EMPTY3                    12
   ...
   /**
    * @brief determine the interrupt source number for the Leon2 empty 4
    *
    * VENDOR_GAISLER
    **/
#define LEON_INTERRUPT_EMPTY4                    13
   ...
   /**
    * @brief determine the interrupt source number for the Leon2 empty 5
    *
    * VENDOR_GAISLER
    **/
#define LEON_INTERRUPT_EMPTY5                    14
   ...
   /**
    * @brief determine the interrupt source number for the Leon2 empty 6
    *
    * VENDOR_GAISLER
    **/
#define LEON_INTERRUPT_EMPTY6                    15
   ...
   /**
    *  @brief determine the trap type for on-chip peripherals
    *
...
#define LEON_TRAP_TYPE( _source ) SPARC_ASYNCHRONOUS_TRAP((_source) + 0x10)
   ...
   /**
    * @brief determine the leon2 trap source number
    *
...
#define LEON_TRAP_SOURCE( _trap ) ((_trap) - 0x10)
   ...
   /**
    * @brief determine the leon2 interrupt trap type
    *
    * @param[in] _trap the trap number
    **/
#define LEON_INT_TRAP( _trap ) \
  ( (_trap) >= LEON_TRAP_TYPE( LEON_INTERRUPT_CORRECTABLE_MEMORY_ERROR ) && \
   ...
   /**
    *  @brief structure for LEON2 memory mapped registers.
    *
...
#define LEON_REG_UART_CTRL_LB     0x00000080 /* Loop Back enable */
   ...
   /**
    *  @brief manipulate the on-chip registers.
    *
   ...
   /**
    * @brief clear the leon2 interrupt source
    **/
...
#define LEON_Mask_interrupt( _source ) \
  do { \
   ...
   /**
    * @brief unmask a leon2 interrupt
    **/
