...
//#ifdef MAIN_LOOP_GO  
        if(executionStatus == EXECUTING)
        {
            ...
            {                         
                ...
                // for (int idx5 = 0; idx5 < core[1].nchan; idx5++)           
                    {
...
/* start tck tasks */       
            ...
            printf("core 1 acitviyt %d init %d prevacq %d\n",core[1].activity,core[1].init,core[1].activityprev  );
